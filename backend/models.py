...
class ConfiguracionFiscal(SQLModel, table=True):
    ...
    retencionNominas: float = Field(default=2.0)
    contingenciasComunesPct: float = Field(default=4.70)
    desempleoPct: float = Field(default=1.55)
    formacionProfesionalPct: float = Field(default=0.10)
    precioHoraExtra: float = Field(default=15.00)
